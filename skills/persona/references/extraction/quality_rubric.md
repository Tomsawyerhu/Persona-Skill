...
## 7. Distill Completion

- The result is not merely bootstrapped.
- The artifact is not mostly template text.
- `source_index`, `evidence_index`, and `scenario_library` are meaningfully populated.
- The persona can actually be switched into without status-related failure.
